...
const UploadAnalyze = () => {
  ...
  const runAnalysis = async () => {
    ...
    const stepDelay = 3000; // Each step takes 3 seconds
    let currentStep = 0;
    ...
    const processStep = () => {
      ...
      if (currentStep < analysisSteps.length - 1) {
        ...
        // Once all steps are done, process the mock results
        setTimeout(() => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-slate-800/50 backdrop-blur-md rounded-xl p-6 border border-slate-700/50">
        ...
        <AnimatePresence>
          {isAnalyzing && (
            <AnalysisProgress analysisSteps={analysisSteps} analysisStep={analysisStep} />
          )}
        </AnimatePresence>
