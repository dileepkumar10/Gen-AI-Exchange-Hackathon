...
from routers import auth_routes, input_routes, chat_routes, comprehensive_analysis
...
app.include_router(comprehensive_analysis.router, prefix="/api/v2", tags=["Comprehensive Analysis"])
